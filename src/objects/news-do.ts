...
export class NewsDO extends DurableObject<Env> {
  ...
  constructor(ctx: DurableObjectState, env: Env) {
    ...
    // 24 = Per-beat streak tracking (beat_streaks table) migration (backfill last_signal_date from actual signal timestamps)
